    ...
    useEffect(() => {
        const fetchMealsByCategory = async () => {
            ...
            try {
                ...
                if (!response.ok) throw new Error('Failed to fetch category meals');
    ...
    return (
        <div className="search-page fade-in">
            ...
            <div className="search-header">
                <h1>{name} Meals</h1>
                <p>Explore all delicious {name.toLowerCase()} recipes.</p>
            </div>
            ...
            {!loading && !error && meals.length === 0 && (
                <div className="empty-state">
                    ...
                    <p>We couldn't find any meals in the {name} category.</p>
                </div>
            )}
                    ...
                    {meals.map((meal) => (
                        <div key={meal.idMeal} className="card">
                            ...
                            <div className="card-content">
                                <span className="card-category">{name}</span>
